...
const annualReportEndpoint = "https://cfda.sos.wa.gov/api/Common/DownloadOnlineFilesByNumber?fileName=Certificates\\2020\\04\\0013415175_OnlineReport.pdf&CorrespondenceFileName=0013415175_OnlineReport.pdf&DocumentTypeId=4";
...
function fetchAnnualReport(annualSearchCriteria) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const data = yield httpService_1.annualPost(annualReportEndpoint, annualSearchCriteria);
        pdf_parse_1.default(data, options).then(function (info) {
            console.log("----------------------ANNUAL REPORT----------------------");
            // TODO: make these temporary variables more descriptive so I can understand what they do
            let properties, str_one, backstr_one, newstr_one, str_two, backstr_two, newstr_two, str_three, backstr_three, newstr_three;
...
//# sourceMappingURL=fetchAnnualReport.js.map