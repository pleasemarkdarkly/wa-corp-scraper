...
async function  fetchBusinessInformation(BussinessID) {
   ...
   return {
      ...
      governor_first_name: BussinessInformation.PrincipalsList[0].FirstName,
      governor_last_name: BussinessInformation.PrincipalsList[0].LastName,
      nature_of_business: BussinessInformation.BINAICSCodeDesc,
      signer_title: BussinessInformation.PrincipalsList[0].Title,
      signer_last_name: BussinessInformation.PrincipalsList[0].LastName,
      signer_first_name: BussinessInformation.PrincipalsList[0].FirstName,
